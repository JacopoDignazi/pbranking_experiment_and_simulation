...
def get_d(res):
    d=res['stance_user_topicwise'].value_counts().to_dict()
#     print(d)
...
def get_C(res):
    cd=make_conf_dict('stance_user_topicwise', 'stance_text_true', res)
#     print(cd)
